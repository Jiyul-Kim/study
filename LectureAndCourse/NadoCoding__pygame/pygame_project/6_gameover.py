...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        ball_img_inx = ball_val["img_idx"]

        ball_size = ball_images[ball_img_inx].get_rect().size
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 공 rect 정보 업데이트
        ball_rect = ball_images[ball_img_inx].get_rect()
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_inx < 3:
                    ...
                    #나눠진 공 정보
                    small_ball_rect = ball_images[ball_img_inx + 1].get_rect()
                    ...
                    balls.append({
                        ...
                        "img_idx" : ball_img_inx + 1, # 공의 이미지 인덱스
                        "to_x" : -3, # x축 이동방향, -3이면 왼쪽, 3이면 오른쪽
                        "to_y" : -6, #y축 이동 방향,
                        "init_spe_y" : ball_speed_y[ball_img_inx + 1] }) # y 최초 속도
    ...
    for idx, val in enumerate(balls):
        ...
        ball_img_inx = val["img_idx"]
        screen.blit(ball_images[ball_img_inx], (ball_pos_x, ball_pos_y))
